    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <Container className="relative z-10 flex-1 flex items-center pt-24 pb-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          >
            {/* Mobile shows over a dark photo overlay, desktop over the
                light page background — so the copy is white on mobile,
                near-black (text-foreground) from lg up. */}
            <h1 className="font-heading text-[48px] md:text-[80px] lg:text-[100px] leading-[0.95] uppercase tracking-[-0.02em] text-white lg:text-foreground">
              Inspiration
              <br />
              <span className="text-white/50 lg:text-foreground/50">for every</span>
              <br />
              Outfit
            </h1>
