  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-expanded={open}
        className="relative inline-flex h-9 w-9 items-center justify-center rounded-full text-white hover:bg-white/5 transition-colors"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute top-full right-0 mt-2 w-80 sm:w-96 max-h-[70vh] overflow-y-auto rounded-2xl bg-background-secondary border border-white/10 shadow-2xl shadow-black/50 z-50"
          >
                    ...
                    >
                      <div className="relative shrink-0">
                        <UserAvatar
                          ...
                          size="sm"
                        />
                        <span className="absolute -bottom-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-white text-black">
