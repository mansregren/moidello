...
export function FloatingBottomNav() {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto rounded-3xl bg-background/70 backdrop-blur-xl border border-foreground/10 shadow-2xl shadow-black/50 px-2 py-2">
            ...
            if (item.primary) {
              return (
                <li key={item.href} className="flex-1">
                  ...
                  >
                    <span className="flex h-9 w-9 items-center justify-center rounded-full bg-foreground text-background shadow-[0_4px_14px_rgba(255,255,255,0.18)]">
                      <Icon
                        className="h-5 w-5"
                        strokeWidth={2.4}
                        aria-hidden="true"
